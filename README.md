# Collector for Pdrf Datasets
[![Build Status](https://github.com/OCHA-DAP/hdx-scraper-pdrf/actions/workflows/run-python-tests.yaml/badge.svg)](https://github.com/OCHA-DAP/hdx-scraper-pdrf/actions/workflows/run-python-tests.yaml)
[![Coverage Status](https://coveralls.io/repos/github/OCHA-DAP/hdx-scraper-pdrf/badge.svg?branch=main&ts=1)](https://coveralls.io/github/OCHA-DAP/hdx-scraper-pdrf?branch=main)
 ...
 **hdx-scraper-pdrf** as specified in the parameter
 *user_agent_lookup*.
